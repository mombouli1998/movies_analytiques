...
# from trinite_movies_sdk import MovieClient, MovieConfig # type: ignore
...
# output_dir= Path(__file__).resolve().parent[1] / "output"

# tags_good_rating=pd.read_parquet("tags_good_rating.parquet")
# tags_compare=pd.read_parquet("tags_compare.parquet")
# tags_by_genre=pd.read_parquet("tags_by_genre.parquet")
# user_tag=pd.read_parquet("user_tag_stats.parquet")
# genre_df=pd.read_parquet("genredf.parquet")
